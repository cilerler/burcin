...
namespace Burcin.Api.Services.GracePeriodManagerService
{
    ...
    public class Service : BackgroundService
    {
        ...
        public Service(ILogger<Service> logger, IOptionsSnapshot<Setting> options)
        {
            _logger = logger;
        ...
        protected override async Task ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            while (!cancellationToken.IsCancellationRequested)
            {
                ...
                await Task.Delay(DateTime.Now-DateTime.Parse(_options.DelayTime), cancellationToken);
            }
        }
        ...
        private void DoWork(CancellationToken cancellationToken) => _logger.LogInformation("Task is running");
