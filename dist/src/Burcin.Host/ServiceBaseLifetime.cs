...
namespace Burcin.Host
{
    public static class ServiceBaseLifetimeHostExtensions
    {
		...
		public static Task RunServiceAsync(this IHostBuilder hostBuilder, CancellationToken cancellationToken = default) => hostBuilder.UseServiceBaseLifetime().Build().RunAsync(cancellationToken);
	}
